...
$(function() {
    var words = ["ALIAS","BIDDER","CONSERVE","DIAOPHROMUS", "GLISMPE","GROCER","HARM","SOLICITUDE",
"ENUMERATE","GALLOP","LIMN","ZIPS","RENDEZVOUS","SCOOT", "SPECKLED","PRUDENT","PREROGATIVE",
"GROTTO","KILN","ANTILOGY","LOGGING","PRAIRIE","SNOWPLOW","PINION"
    ];
    var selectedWords = words.sort(() => 0.5 - Math.random()).slice(0, 12);
    ...
    var puzzle = wordfind.newPuzzle(
        words, { height: 12, width: 12, fillBlanks: true }
    );
